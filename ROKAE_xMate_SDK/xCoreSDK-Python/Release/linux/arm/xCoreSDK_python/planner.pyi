...
class CartMotionGenerator:
    ...
    """
    def __init__(self, speed_factor: typing.SupportsFloat | typing.SupportsIndex, s_goal: typing.SupportsFloat | typing.SupportsIndex) -> None:
        """
        ...
        """
    def calculateDesiredValues(self, t: typing.SupportsFloat | typing.SupportsIndex, delta_s_d: xCoreSDK_python.PyTypeDouble) -> bool:
        """
        计算时间t时的弧长s
        ...
        """
    def calculateSynchronizedValues(self, s_init: typing.SupportsFloat | typing.SupportsIndex) -> None:
        """
        同步当前弧长
    ...
    def getTime(self) -> float:
        ...
        Returns:
            运动时间，单位：秒
        """
    def setMax(self, ds_max: typing.SupportsFloat | typing.SupportsIndex, dds_max_start: typing.SupportsFloat | typing.SupportsIndex, dds_max_end: typing.SupportsFloat | typing.SupportsIndex) -> None:
        """
        设置笛卡尔空间运动参数
...
class FollowPosition_5:
    ...
    def init(self, robot: xCoreSDK_python.Cobot_5, model: xCoreSDK_python.model.xmateModel_1_5) -> None:
        ...
        Args:
            ...
            model: rokae::xMateModel实例, 通过robot.model()获取
        """
    def setScale(self, scale: typing.SupportsFloat | typing.SupportsIndex) -> None:
        """
        ...
        """
    @typing.overload
    def start(self, jnt_desire: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex], "FixedSize(5)"]) -> None:
        """
        开始目标跟随 - 轴角度。该接口非阻塞。
    ...
    def stop(self) -> None:
        ...
        """
    @typing.overload
    def update(self, jnt_desired: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex], "FixedSize(5)"]) -> None:
        """
        更新期望的目标轴角度
...
class FollowPosition_6:
    ...
    def setScale(self, scale: typing.SupportsFloat | typing.SupportsIndex) -> None:
        ...
        """
    @typing.overload
    def start(self, jnt_desire: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex], "FixedSize(6)"]) -> None:
        """
        开始目标跟随 - 轴角度。该接口非阻塞。
    ...
    def stop(self) -> None:
        ...
        """
    @typing.overload
    def update(self, jnt_desired: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex], "FixedSize(6)"]) -> None:
        """
        更新期望的目标轴角度
...
class FollowPosition_7:
    ...
    def setScale(self, scale: typing.SupportsFloat | typing.SupportsIndex) -> None:
        ...
        """
    @typing.overload
    def start(self, jnt_desire: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex], "FixedSize(7)"]) -> None:
        """
        开始目标跟随 - 轴角度。该接口非阻塞。
    ...
    def stop(self) -> None:
        ...
        """
    @typing.overload
    def update(self, jnt_desired: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex], "FixedSize(7)"]) -> None:
        """
        更新期望的目标轴角度
...
class JointMotionGenerator:
    ...
    Note:
        ...
        (Kogan Page Science Paper edition).
    """
    def __init__(self, speed_factor: typing.SupportsFloat | typing.SupportsIndex, q_goal: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex], "FixedSize(7)"]) -> None:
        """
        ...
        """
    def calculateDesiredValues(self, t: typing.SupportsFloat | typing.SupportsIndex, delta_q_d: list) -> bool:
        """
        计算时间t时的关节角度增量
        ...
        Returns:
            false: 运动规划没有结束 | true: 运动规划结束
        """
    def calculateSynchronizedValues(self, q_init: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex], "FixedSize(7)"]) -> None:
        """
        同步当前关节角度
    ...
    def getTime(self) -> float:
        ...
        Returns:
            运动时间，单位：秒
        """
    def setMax(self, dq_max: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex], "FixedSize(7)"], ddq_max_start: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex], "FixedSize(7)"], ddq_max_end: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex], "FixedSize(7)"]) -> None:
        """
        设置轴空间S速度规划的运动参数
